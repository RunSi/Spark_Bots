...
def greetings():
    ...
    return "Hi my name is %s.<br/>" \
            "I am the spirit of No 6.<br/>"\
            "I am all things West Ham.<br/>"\
            "Bow unto me.<br/>"\
            "COYI.<br/>"\
...
def spark_webhook():
    if request.method == 'POST':
        ...
        if "@sparkbot.io" not in webhook['data']['personEmail']:
            ...
            print(in_message)
            if in_message.startswith('bobby help me'):
                msg = help_me()
            elif in_message.startswith('help me'):
                msg = help_me()
            elif in_message.startswith('bobby hello'):
                msg = greetings()
            elif in_message.startswith('bobby milner'):
                msg = milner()
